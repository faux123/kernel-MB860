/*
 * arch/arm/mach-tegra/odm_kit/query/olympus/subboards/nvodm_query_discovery_e951_addresses.h
 *
...
{
// WLAN Dima change controller number to SDIO1 to reflect Motorola changes
    { NvOdmIoModule_Sdio, 0x00, 0x0 , 0 },    /* WLAN is on SD Bus */
    { NvOdmIoModule_Gpio, NVODM_PORT('u'), 0x3 , 0 },    /* GPIO Port U and Pin 3 */
    { NvOdmIoModule_Gpio, NVODM_PORT('u'), 0x2 , 0 },    /* GPIO Port U and Pin 2 for Moto-daughter board*/
