/*
 * arch/arm/mach-tegra/odm_kit/query/olympus/nvodm_query_pinmux.c
 *
...
static const NvU32 s_NvOdmPinMuxConfig_Sdio_05[] = {
    NvOdmSdioPinMap_Config1, // WLAN Dima now this is Wifi and again swapping lines one and two
    NvOdmSdioPinMap_Config5,
    NvOdmSdioPinMap_Config2,
