/*
 * arch/arm/mach-tegra/odm_kit/query/etna/nvodm_query.c
 *
...
static NvOdmWakeupPadInfo s_NvOdmWakeupPadInfo[] =
{
    ...
    {NV_TRUE,   8, NvOdmWakeupPadPolarity_High},    // Wake Event  8 - gmi_wp_n (WAN_HOST_WAKE)
...
#ifdef MOT_TURN_ON_LTE
    {NV_TRUE,  27, NvOdmWakeupPadPolarity_Low},     // Wake Event 27 - gp3_ps[0] (WAN_RESET_MCU_B)
#else
    {NV_FALSE,  27, NvOdmWakeupPadPolarity_Low},     // Wake Event 27 - gp3_ps[0] (WAN_RESET_MCU_B)
#endif
 ...
 static const NvOdmPinAttrib s_pin_config_attributes[] = {
    ...
    */
    { NvOdmPinRegister_Ap20_PullUpDown_E,
     NVODM_QUERY_PIN_AP20_PULLUPDOWN_E(0x2, 0x2, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x2, 0x2) },
