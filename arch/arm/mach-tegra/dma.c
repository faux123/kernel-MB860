	...
	struct tegra_dma_req *req)
{
	...
	case TEGRA_DMA_REQ_SEL_SPI:
		 ...
		 * i.e. if multiple of 32 byes equal to 8 word burst,
		 * Multiple of 16 bytes equal to 4 word burst
		 * else burst size is 1 word */
		if (req->size & 0xF)
