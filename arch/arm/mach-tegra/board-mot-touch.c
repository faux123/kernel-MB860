...
struct qtouch_ts_platform_data ts_platform_etna_p_1_37 = 
{
/*	.flags		= (QTOUCH_SWAP_XY | */
/*			   QTOUCH_EEPROM_CHECKSUM), */
	.flags		= (QTOUCH_SWAP_XY | 
...
struct qtouch_ts_platform_data ts_platform_etna_p_1_43 = 
{
/*	.flags		= (QTOUCH_SWAP_XY | */
/*			   QTOUCH_EEPROM_CHECKSUM), */
	.flags		= (QTOUCH_SWAP_XY | 
...
struct qtouch_ts_platform_data ts_platform_etna_m_1 = 
{
/*	.flags		= (QTOUCH_SWAP_XY | */
/*			   QTOUCH_EEPROM_CHECKSUM), */
	.flags		= (QTOUCH_SWAP_XY | 
...
*/
	...
	struct qtouch_ts_platform_data ts_platform_sunfire_p_1 = {
	/*	.flags		= (QTOUCH_SWAP_XY | */
	/*			   QTOUCH_EEPROM_CHECKSUM), */
		.flags		= (QTOUCH_SWAP_XY |
						QTOUCH_USE_MULTITOUCH |
...
static int vkey_size_etna_p_1_41[4][4] = 
            { {67,900,134,80},    // KEY_MENU
              {200,900,134,80},    // KEY_HOME
              {337,900,134,80},    // KEY_BACK
              {472,900,134,80}};  // KEY_SEARCH

static int vkey_size_etna_p_1_42[4][4] = 
            { {57,1005,81,71},    // KEY_MENU
              {199,1005,81,71},    // KEY_HOME
              {340,1005,81,71},    // KEY_BACK
              {482,1005,81,71}};  // KEY_SEARCH

static int vkey_size_sunfire_p_1[4][4] = {
	/* KEY_MENU */
	{67, 1007, 147, 67},
	/* KEY_HOME */
	{208, 1007, 147, 67},
					...
					struct kobj_attribute *attr, char *buf)
{
	...
	else if ( machine_is_sunfire())
	{
		...
		return sprintf(buf,
			...
			__stringify(EV_KEY) ":" __stringify(KEY_BACK) ":%d:%d:%d:%d:"
			__stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":%d:%d:%d:%d\n",
				vkey_size_sunfire_p_1[0][0],
				vkey_size_sunfire_p_1[0][1],
				vkey_size_sunfire_p_1[0][2],
				vkey_size_sunfire_p_1[0][3],
				vkey_size_sunfire_p_1[1][0],
				vkey_size_sunfire_p_1[1][1],
				vkey_size_sunfire_p_1[1][2],
				vkey_size_sunfire_p_1[1][3],
				vkey_size_sunfire_p_1[2][0],
				vkey_size_sunfire_p_1[2][1],
				vkey_size_sunfire_p_1[2][2],
				vkey_size_sunfire_p_1[2][3],
				vkey_size_sunfire_p_1[3][0],
				vkey_size_sunfire_p_1[3][1],
				vkey_size_sunfire_p_1[3][2],
				vkey_size_sunfire_p_1[3][3]);
	}
	else
		return 0;
};
